...
public class HeapTest {
	...
	public void testLeftRightParent() {
		final Heap<Integer> h = new Heap<>(Integer.MIN_VALUE, COMPARATOR, 0,1,2,3,4,5,6);
	...
	public void testHeapify() throws Exception {
		final Heap<Integer> h = new Heap<>(Integer.MIN_VALUE, COMPARATOR, 4,1,3,2,16,9,10,14,8,7);
	...
	public void testAddEmpty() throws Exception {
		final Heap<Integer> h = new Heap<>(Integer.MIN_VALUE, COMPARATOR);
		h.add(15);
		h.add(16);
		h.add(17);
...
//		assertEquals(Arrays.asList(16, 14, 10, 9, 8, 7, 4, 3, 2, 1), h.sort());
	...
	public void testRandomSort() throws Exception {
		...
		final Heap<Integer> h = new Heap<>(Integer.MIN_VALUE, COMPARATOR, list);
